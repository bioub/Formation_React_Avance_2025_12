...
function Exercise5() {
  ...
  // const primeNumber = findClosestLowestPrime(value);
  const primeNumber = useMemo(() => findClosestLowestPrime(value), [value]);
  ...
  const render = (
    <div className="Exercise5">
      ...
      <div className="box">
        ...
        />
        the closest lowest prime to {value} is {primeNumber}
