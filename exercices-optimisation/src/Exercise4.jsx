...
// Si on ne veut pas avoir à utiliser useCallback :
// const TodosList = memo(function TodosList(props) {
//   console.log('render TodosList');
//   return (
//     <div className="TodosList">
...
//   );
// }, (prevProps, nextProps) => {
//   // ici on test l'égalité des props uniquement en regardant la prop todos
//   return prevProps.todos === nextProps.todos;
// });

// React Compiler : si on ne veut pas utiliser memo
// installer babel-plugin-react-compiler
// et ajouter le plugin dans vite.config.js
